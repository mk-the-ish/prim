...
const NewTuitionZWG = ({ studentId: propStudentId, onSuccess }) => {
    ...
    const mutation = useMutation({
        mutationFn: async (paymentRow) => {
            ...
            const { error: insertError } = await supabase.from('Fees').insert([
                { ...paymentRow, Type: 'Tuition', Currency: 'ZWG', AmountZWG: amountZWG, AmountUSD: amountUSD }
            ]);
    ...
    return (
        <Form onSubmit={handleSubmit} loading={mutation.isLoading} title="New ZWG Tuition Payment">
