...
import { fetchUser, fetchLevyUSD } from '../../api';
...
const LevyUSD = () => {
    ...
    const currentItems = usdLevies.slice(indexOfFirstItem, indexOfLastItem);
    const totalPages = Math.ceil(usdLevies.length / ITEMS_PER_PAGE);
        ...
        <div className="container mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="flex justify-between items-center px-6 py-4 bg-gray-50">
                <div className="text-sm text-gray-600">
                    Showing {indexOfFirstItem + 1} to {Math.min(indexOfLastItem, usdLevies.length)} of {usdLevies.length} entries
                </div>
