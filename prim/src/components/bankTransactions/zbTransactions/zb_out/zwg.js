...
const TOzwg = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const { error } = await supabase.from('tuition_out_txn_zwg').insert([formData]);
    ...
    return (
        <div className="max-w-lg mx-auto mt-10 p-6 bg-gray-100 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-center mb-6">Add ZWG Tuition Payment</h2>
