...
const LOVusd = () => {
    ...
    const mutation = useMutation({
        ...
        onSuccess: () => {
            ...
            queryClient.invalidateQueries(['cbz_out_usd']);
        },
        onError: () => {
    ...
    return (
        <div className="p-0">
            ...
            <FormModal open={showModal} onClose={() => setShowModal(false)} title="Add USD Outgoing Payment">
