...
const LIVzwg = () => {
    ...
    const mutation = useMutation({
        ...
        onSuccess: () => {
            ...
            queryClient.invalidateQueries(['cbz_in_zwg']);
        },
        onError: () => {
    ...
    return (
        <div className="p-0">
            ...
            <FormModal open={showModal} onClose={() => setShowModal(false)} title="Add ZWG Incoming Payment">
