...
const TIusd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const { error } = await supabase.from('tuition_in_txn_usd').insert([formData]);
    ...
    return (
        <div className="max-w-lg mx-auto mt-10 p-6 bg-gray-100 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-center mb-6">Add USD Tuition Revenue</h2>
